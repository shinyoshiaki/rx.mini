...
test("wait", function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    var wait;
        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, Promise.all([
                        new Promise(function (r) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                            var _a, exist, result;
                        ...
                        new Promise(function (r) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                            ...
                            return tslib_1.__generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0: return [4 /*yield*/, wait.create("test", function () {
                                            return new Promise(function (r) { return setTimeout(function () { return r(["solve2"]); }, 1000); });
                                        })];
                                    case 1:
                                        _a = _b.sent(), exist = _a.exist, result = _a.result;
